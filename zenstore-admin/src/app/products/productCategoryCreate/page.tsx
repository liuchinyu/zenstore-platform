...
import { selectProductCategories } from "@/store/selectors/categorySelector";
...
export default function productCategory() {
  ...
  const productCategoires = useAppSelector(selectProductCategories);

  const category_type = "產品";
  ...
  const categoryTree = buildCategoryTree(productCategoires);
