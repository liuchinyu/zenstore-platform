...
import { fetchHotProducts } from "@/store/productSlice";
import { useProductCarousel } from "@/hooks/useProductCarousel";
import ProductCard from "@/components/ProductCard/ProductCard";
import { selectHotProducts } from "@/store/selectors/productSelector";
...
const HotProducts = ({ isProductLoaded }: HotProductsProps) => {
  const {
    cardContainerRef,
    currentPosition,
    products,
    ...
    fetchProducts: fetchHotProducts,
    productsSelector: selectHotProducts,
  });
